/**
 * TooltipManager - Global tooltip system for managing tooltips across the application
 * Automatically detects and handles all elements with [data-tooltip-trigger] attribute
 */
