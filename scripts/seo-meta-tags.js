...
// Main initialization function - deferred to idle time
function initializeSEOMetaTags() {
  // Get page metadata
...
// Use requestIdleCallback to defer SEO meta tag generation
// This prevents blocking the main thread during critical rendering
if ('requestIdleCallback' in window) {
  requestIdleCallback(() => {
    initializeSEOMetaTags();
  }, { timeout: 2000 });
} else {
  // Fallback for browsers that don't support requestIdleCallback
  setTimeout(initializeSEOMetaTags, 1);
}

export { initializeSEOMetaTags, updatePageBackground, getUEPageMetadata };
