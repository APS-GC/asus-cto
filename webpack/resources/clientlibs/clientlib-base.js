...
(function (document) {
  ...
  window.CMP.image.dynamicMedia = (function () {
    ...
    var setDMAttributes = function (component, properties) {
      ...
      var hasWidths =
        (properties.widths && properties.widths.length > 0) || Object.keys(smartCrops).length > 0;
      if (hasWidths) {
  ...
  document.dispatchEvent(
    new CustomEvent('core.wcm.components.commons.site.image.dynamic-media.loaded'),
  );
})(window.document);
...
(function () {
  ...
  function updateSearchResultsStatusMessageElement(searchElementId, totalResults) {
    ...
    searchResultsStatusMessage.innerText =
      totalResults > 0 ? searchResultsFoundMessage : searchResultsNotFoundMessage;
  }
  ...
  Search.prototype._onScroll = function (event) {
    ...
    if (
      this._elements.results.scrollTop + 2 * this._elements.results.clientHeight >=
    ...
    if (self._hasMoreResults) {
      ...
      request.onload = function () {
        ...
        if (request.status >= 200 && request.status < 400) {
          ...
          if (
            self._elements.results.querySelectorAll(selectors.item.self).length %
...
(function () {
  ...
  FormText.prototype._onInvalid = function (event) {
    ...
    if (displayValidationMessage) {
      var validationMessage = event.target.parentElement.querySelector(
